...
+q
fo dash_dbg.exe
dummy0 b c {"Starting Programming -- Part1\n"  ; fr m x00.img   0x80100000; c}
dummy1 b c {if stage == 0 {"Starting Programming -- Part2\n"; fr m x01.img 0x80100000; c}{"PART1 ERROR\n"}}
dummy2 b c {if stage == 0 {"Starting Programming -- Part3\n"  ; fr m x02.img 0x80100000; c}{"PART2 ERROR\n"}} 
dummy3 b c {if stage == 0 {"Starting Programming -- Part4\n"  ; fr m x03.img 0x80100000; c}{"PART3 ERROR\n"}} 
dummy4 b c {if stage == 0 {"Programming Complete"; q}{"PART4 ERROR"}}
r
