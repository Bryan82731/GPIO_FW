...
+q
fo dash_dbg.exe
dummy0 b c {"Starting Programming -- Part1\n"  ; fr m xaa.img   0x80100000; c}
dummy1 b c {if stage == 0 {"Starting Programming -- Part2\n"; fr m xab.img 0x80100000; c}{"PART1 ERROR\n"}}
dummy2 b c {if stage == 0 {"Starting Programming -- Part3\n"  ; fr m xac.img 0x80100000; c}{"PART2 ERROR\n"}} 
dummy3 b c {if stage == 0 {"Starting Programming -- Part4\n"; fr m xad.img 0x80100000; c}{"PART3 ERROR\n"}} 
dummy4 b c {if stage == 0 {"Starting Programming -- Part5\n"; fr m xae.img 0x80100000; c}{"SMBIOS ERROR\n"}} 
...
dummy7 b c {if stage == 0 {"Programming Complete"; q}{"PART6 ERROR"}}
r
