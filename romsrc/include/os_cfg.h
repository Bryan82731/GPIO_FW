...
/* --------------------- TASK STACK SIZE ----------------------   */
/* Timer      task stack size (# of OS_STK wide entries)          */
/* Timer      task stack size (# of OS_STK wide entries)          */
...
#if 0
#ifndef OS_MSG_EN 
#define OS_MSG_EN                 1     /* Enable (1) or Disable (0) code generation for MESSAGES       */
#endif
#define OS_MSG_MAX               32     /*     Maximum number of messages                               */
#endif
...
#define OS_TASK_MSG_EN            1     /*     Include code for OSTaskMsg???()                          */
