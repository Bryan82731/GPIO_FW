...
typedef struct
{
    union
    {
        ...
        struct
        {
            INT32U length: 11, rsvd:15, alsel:3, valid:1, eor:1, own:1;
        }cmd;
    }offset1;
...
#define VA2PA(vaddr)		((INT32U) (vaddr) & ~0x80000000)
...
EXTERN char (*dhcpReply_F)(int type, unsigned char *opt, int len);
