...
int asn1_get_principal_name(unsigned char **p, unsigned char *end, krb5_principal server );
int asn1_get_transited(unsigned char **p, unsigned char *end, krb5_transited *transit);
int asn1_get_GeneralizedTime( unsigned char **p,  unsigned char *end, krb5_timestamp *val );
int asn1_get_string(unsigned char **p, unsigned char *end, int *len, krb5_data *at);
